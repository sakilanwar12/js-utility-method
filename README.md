...
| Name                                                                                                           | Description                                                              |
| -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [convertArrayToCSV](https://github.com/sakilanwar12/js-utility-method/tree/main/src/convert/ConvertArrayToCSV) | Converts an array of objects or an array of arrays into a CSV string.    |
